#include "EditPictureMenu.hpp"

EditPictureMenu::EditPictureMenu() {
    this->name = "";
    this->year = ""; 
    this->nominations = "";
    this->rating = "";
...
void EditPictureMenu::printMenu() {
    this->clearScreen();
    this->printHeader("Edit Picture");
    std::cout << std::endl;
...
std::string EditPictureMenu::getUserInfo() {
    std::string input = "";
    while(true) {
        ...
        if(input == "S" || input == "s") {
            if(this->submit()) {
                if(this->name != "") this->picture->setName(this->name);
                if(this->year != "") this->picture->setYear(this->year);
                if(this->nominations != "") this->picture->setNominations(this->nominations);
                if(this->rating != "") this->picture->setRating(this->rating);
                if(this->duration != "") this->picture->setDuration(this->duration);
                if(this->genre1 != "") this->picture->setGenre1(this->genre1);
                if(this->genre2 != "") this->picture->setGenre2(this->genre2);
                if(this->release != "") this->picture->setRelease(this->release);
                if(this->metacritic != "") this->picture->setMetacritic(this->metacritic); 
                if(this->synopsis != "") this->picture->setSynopsis(this->synopsis);
                return "S";
            }
        }
        ...
        this->printMenu();
        if(input != "Y" && input != "N" && input != "T" && input != "4" && input != "D" && input != "1" && input != "2" && input != "L" && input != "M" && input != "P") {
...
void EditPictureMenu::setPicture(Picture* picture) {
    this->picture = picture;
}

Picture* EditPictureMenu::getPicture() {
    return this->picture;
}

bool EditPictureMenu::submit() {
...
void EditPictureMenu::setNominations() {
    std::string input = "";
...
void EditPictureMenu::setRating() {
    std::string input = "";
...
void EditPictureMenu::setDuration() {
    std::string input = "";
...
void EditPictureMenu::setGenre1() {
...
void EditPictureMenu::setGenre2() {
    std::cout << "Please pick a genre" << std::endl;
    this->printGenre();
    std::string input = "";
    int result = 0;
...
void EditPictureMenu::setRelease() {
...
void EditPictureMenu::setMetacritic() {
    std::string input = "";
    int result = 0;
...
void EditPictureMenu::setSynopsis() {
    std::string input = "";
...
void EditPictureMenu::printGenre() {
...
void EditPictureMenu::printMonths() {
